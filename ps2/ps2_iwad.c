...
//
// Scans cdfs (disc/ISO) for IWADs and PWADs, shows a
...
char *PS2_GetIWAD(void)
{
...

    {
        ...
        settings[6].action = PS2_Shutdown;
        ...
        if (settings[3].cur != THIS_RENDERER)
        {
            ...
            args[0] = (char *)g_renderer_elf[settings[3].cur];
            ...
            PS2_Exec(g_renderer_elf[settings[3].cur], na, args);
        }
